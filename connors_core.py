# -*- coding: utf-8 -*-
# Extraído do app Connors RSI original apenas para reutilização no Radar Mestre.
# Fórmulas, parâmetros e funções foram preservados; a interface Streamlit fica na página original.
